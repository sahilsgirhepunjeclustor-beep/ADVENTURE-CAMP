...
function AuthScreen(param) {
    ...
    const [established, setEstablished] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [primaryLocations, setPrimaryLocations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [batchCapacity, setBatchCapacity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('30');
    ...
    const [ifscCode, setIfscCode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    // Documents
    const [govId, setGovId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const [regDoc, setRegDoc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const [panDoc, setPanDoc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const [bankDoc, setBankDoc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const [safetyDoc, setSafetyDoc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    ...
    const handleFileUpload = async (e, setter)=>{
        ...
        reader.onloadend = async ()=>{
            ...
            if (file.type.startsWith('image/')) {
                data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compressImage"])(data, 1200, 0.5);
            }
            setter({
                name: file.name,
                type: file.type,
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                ...
                description: "".concat(file.name, " is ready for registry audit.")
            });
        };
    ...
    const handleLogin = (e)=>{
        ...
        if (user.role === 'organizer') {
            if (user.isRejected) {
                setError("Registry Rejected: ".concat(user.rejectionReason || 'Compliance audit failure.'));
                return;
            }
            if (!user.isApproved) {
        ...
        if (user.status === 'suspended' || user.status === 'blocked') {
            setError("Account ".concat(user.status, ". Contact administration."));
            return;
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCurrentUser"])(user);
        onLogin(user);
    };
    const handleSignup = (e)=>{
        ...
        if (role === 'organizer') {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAdminNotification"])({
                ...
                message: "".concat(firstName, " ").concat(lastName, " (").concat(businessName, ") has requested access. Documents staged for audit."),
    ...
    const handleFindAccount = (e)=>{
        e.preventDefault();
        const users = Object.values((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUsers"])());
        ...
        if (found) {
            ...
            setSuccess("Account identified! Registered email: ".concat(found.email));
...
_s(AuthScreen, "3ChZLykx4hpoWykO63VLv2m2Y2o=");
_c = AuthScreen;
var _c;
...
//# sourceMappingURL=src_components_auth_AuthScreen_tsx_8ba0946f._.js.map